<template>
  <Layout>
    <v-content>
      <v-container  class="pt-12 px-0" fluid>

        <div id="about" class="pb-8 px-12">
          <v-lazy
          ...
          >
            <v-row justify="space-between" align="center">
              <v-col cols="5">
                <v-card flat>
                  <v-img contain height="700px" :src="about.img" :lazy-src="about.lazy" />
                </v-card>
              </v-col>
        ...
        <div id="explore" class="pt-8 pb-12 px-12">
          <p class="pb-10 text-center display-2" v-html="explore.title[getLang]" />
          <v-lazy
          ...
          >
            <v-row class="pt-12" justify="space-between" align="center">
              <v-col cols="4" v-for="(image, i) in explore.images" :key="'exploreImages-' + i">
                  <v-img gradient="to top right, rgba(0,0,0,.15), rgba(0,0,0,.15)" :src="image.img">
                    <div style="height: 100%" class="d-flex flex-column justify-center align-center">
                      <p class="display-1 white--text" v-html="image.p[getLang]" />
                      <v-btn
        ...
        <div id="artists" style="background-color: #DEDEDE" class="pt-12" height="200px">
        </div>
  ...
  data () {
    return {
      ...
      about: {
        ...
        lazy: "https://res.cloudinary.com/de1jgt6c5/image/upload/q_auto,fl_lossy,f_auto,dpr_auto,w_100,h_100/v1582236536/artventures/img21.png",
      },
      explore: {
        isActive: false,
        title: {
        ...
        images: [
          {
            ...
            lazy: 'https://res.cloudinary.com/de1jgt6c5/image/upload/q_auto,fl_lossy,f_auto,dpr_auto,w_100,h_100/v1585320134/artventures/img22.jpg',
            p: {
              gr: 'Individuals',
              en: 'Individuals',
            },
          },
          {
            ...
            lazy: 'https://res.cloudinary.com/de1jgt6c5/image/upload/q_auto,fl_lossy,f_auto,dpr_auto,w_100,h_100/v1585320139/artventures/img23.jpg',
            p: {
              gr: 'Businesses',
              en: 'Businesses',
            }
          },
          {
            ...
            lazy: 'https://res.cloudinary.com/de1jgt6c5/image/upload/q_auto,fl_lossy,f_auto,dpr_auto,w_100,h_100/v1585320139/artventures/img24.jpg',
            p: {
              gr: 'Hotels',
              en: 'Hotels',
            }
